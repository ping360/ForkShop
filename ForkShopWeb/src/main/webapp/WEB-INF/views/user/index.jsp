...
<div class="row">
	<div class="col-md-2 col-xs-12">
		<form:form class="form-horizontal" action="/" method="GET" modelAttribute="filter">
			<custom:hiddenInputs excludeParams="min, max, search, brand, _brandId, category, _categoryId"/>
			...
			<div class="form-group">
				<label class="contol-label col-sm-12">Category</label>
				<div class="col-sm-12">
					<form:checkboxes element="div" items="${categorys}" itemValue="id" itemLabel="name" path="categorysIds"/>
				</div>
			</div>
